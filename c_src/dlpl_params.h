 ...
 * ========================================================================== */
    ...
    #define DLPL_Q          7681    /* Prime modulus (7681 ≡ 1 mod 512, NTT-friendly) */
    #define DLPL_K          2       /* Block-circulant dimension */
    ...
    #define DLPL_N          256     /* Polynomial degree */
    #define DLPL_Q          7681    /* Prime modulus (7681 ≡ 1 mod 512, NTT-friendly) */
    #define DLPL_K          4       /* Block-circulant dimension */
    #define DLPL_ETA_S      2       /* Secret distribution bound */
    #define DLPL_ETA_E      2       /* Error distribution bound */
    #define DLPL_LOGQ       13      /* ceil(log2(q)) */
    #define DLPL_NAME       "DLPL-1024"
...
/* Kyber-style bit-packed size calculations */
#define DLPL_POLY_BYTES     ((DLPL_N * DLPL_LOGQ + 7) / 8)  /* Bit-packed polynomial size */
